export const socialLinks = [
  {
    href: "https://github.com/RealityMHG",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.linkedin.com/in/rafaelregocoder/",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://app.daily.dev/realitymhg",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  return (
    <section id="contact" className="section mb-28">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-6 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-3 lg:max-w-[16ch] reveal-up">
            Connect with me
          </h2>

          <p className="text-strong mt-3 mb-3 max-w-[50ch] reveal-up">
          ...
          <div className="flex items-center gap-2 mt-0">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                href={href}
                target="_blank"
                className="w-12 h-12 grid place-items-center border-text border-[1px] rounded-full hover:bg-text hover:text-background transition-all hover:shadow-lg hover:shadow-stronger reveal-up"
              >
                {icon}
              </a>
            ))}
        ...
        <form
          action="https://getform.io/f/aqoodjqa"
          method="POST"
        ...
        >
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              required
              className="text-field resize-none min-h-60 reveal-up"
            ></textarea>
          </div>
          <button
            type="submit"
